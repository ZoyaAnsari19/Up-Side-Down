      ...
      <div className="relative z-10 w-full md:w-1/2 lg:w-2/5 px-6 sm:px-8 lg:px-12 xl:px-20">
        ...
        <div className="flex flex-col gap-3 max-w-sm">
          {[
            ...
            <button
              key={platform.name}
              className="group flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/30 hover:border-white/60 rounded-lg transition-all duration-300 hover:bg-white/20 w-full"
            >
              {/* Icon Placeholder */}
