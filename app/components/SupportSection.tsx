...
export default function SupportCenter() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900" id='support'>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 ml-80 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
                <HelpCircle className="w-6 h-6 text-white" />
              </div>
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-white">Support Center</h1>
                <p className="text-xs sm:text-sm text-gray-400">Available 24/7 to assist you</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="relative max-w-2xl mx-auto">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            {filteredCategories.map(category => {
              ...
              return (
                <div key={category.id} className="bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 overflow-hidden hover:border-white/20 transition-all">
                  <div className="p-4 sm:p-6 bg-gradient-to-r from-blue-500/20 to-purple-600/20 border-b border-white/10">
                    <div className="flex items-center space-x-3">
                  ...
                  <div className="p-4 sm:p-6 space-y-3">
                    {category.items.map((item, idx) => (
                      <button
                        key={idx}
                        className="w-full group bg-white/5 hover:bg-white/10 rounded-xl p-4 sm:p-5 transition-all text-left border border-transparent hover:border-white/10"
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1 min-w-0">
                            <h4 className="text-base sm:text-lg font-semibold text-white mb-1 group-hover:text-blue-400 transition-colors">
                              {item.title}
                            </h4>
          ...
          <div className="space-y-6">
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 overflow-hidden sticky top-24">
              <div className="p-4 sm:p-6 bg-gradient-to-r from-blue-500/20 to-purple-600/20 border-b border-white/10">
                <div className="flex items-center space-x-3">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-white">Recent Articles</h3>
                </div>
              </div>
              ...
              <div className="p-4 sm:p-6 space-y-4">
                {recentArticles.map((article, idx) => (
                  <button
                    key={idx}
                    className="w-full group text-left bg-white/5 hover:bg-white/10 rounded-lg p-3 sm:p-4 transition-all border border-transparent hover:border-white/10"
                  >
                    ...
                    <h4 className="text-sm sm:text-base font-medium text-white mb-2 group-hover:text-blue-400 transition-colors line-clamp-2">
                      {article.title}
                    </h4>
            ...
            <div className="bg-gradient-to-br from-green-600/20 to-emerald-600/20 backdrop-blur-lg rounded-2xl border border-green-500/20 p-4 sm:p-6 text-center">
              ...
              <h4 className="text-base sm:text-lg font-bold text-white mb-2">24/7 Support</h4>
      ...
      {/* Footer */}
      <footer className="bg-black/50 backdrop-blur-lg border-t border-white/10 mt-12 sm:mt-20">
