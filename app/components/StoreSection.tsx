            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 group cursor-pointer">
                        <div className="relative aspect-video bg-gray-800 rounded-lg overflow-hidden">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <span className="text-white/40 text-6xl font-bold">BATTLEGROUNDS</span>
                                <img
                    ...
                    <div 
                        ...
                        className="lg:space-y-4 flex lg:flex-col overflow-x-auto lg:overflow-x-visible gap-4 lg:gap-0 pb-4 lg:pb-0 -mx-4 px-4 lg:mx-0 lg:px-0 scroll-smooth cursor-grab active:cursor-grabbing"
                        style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
                    >
                        {sideNews.map((news, index) => (
                            <div
                                key={news.id}
                                className="group cursor-pointer bg-gray-900 rounded-lg overflow-hidden hover:bg-gray-800 transition-colors flex-shrink-0 w-80 lg:w-auto"
                            >
